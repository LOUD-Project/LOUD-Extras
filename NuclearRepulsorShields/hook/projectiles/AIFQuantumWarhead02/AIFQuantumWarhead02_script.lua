...
if version >= 3652 then
	LOG('Nuclear Repulsor Shields: [AIFQuantumWarhead02_script.lua '..debug.getinfo(1).currentline..'] - Gameversion is 3652 or newer. Hooking "AIFQuantumWarhead02".')
------------------------------------------------------------------------------
...
TypeClass = AIFQuantumWarhead02
	...
	LOG('Nuclear Repulsor Shields: [AIFQuantumWarhead02_script.lua '..debug.getinfo(1).currentline..'] - Gameversion is older then 3652. No need to hook "AIFQuantumWarhead02".')
end
