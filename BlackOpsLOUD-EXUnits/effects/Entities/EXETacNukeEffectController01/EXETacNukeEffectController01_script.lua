--****************************************************************************
--**
--**  File     :  /mods/BlackOpsLOUD-EXUnits/effects/Entities/EXBillyEffectController01/EXBillyEffectController01_script.lua
...
EXETacNukeEffectController01 = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        self:CreateProjectile('/mods/BlackOpsLOUD-EXUnits/effects/Entities/EXETacNukeEffect01/EXETacNukeEffect01_proj.bp',0,FireballDomeYOffset,0,0,0,1)

        -- Create projectile that controls plume effects
        local PlumeEffectYOffset = -0.25
        self:CreateProjectile('/mods/BlackOpsLOUD-EXUnits/effects/Entities/EXETacNukeEffect02/EXETacNukeEffect02_proj.bp',0,PlumeEffectYOffset,0,0,0,1)
    ...
    CreateInitialFireballSmokeRing = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            self:CreateProjectile('/mods/BlackOpsLOUD-EXUnits/effects/Entities/EXETacNukeShockwave01/EXETacNukeShockwave01_proj.bp', X * OffsetMod , 0.25, Z * OffsetMod, X, 0, Z)
    ...
    CreateOuterRingWaveSmokeRing = function(self)
        ...
        for i = 0, (sides-1) do
            local X = math.sin(i*angle)
            local Z = math.cos(i*angle)
            local proj =  self:CreateProjectile('/mods/BlackOpsLOUD-EXUnits/effects/Entities/EXETacNukeShockwave02/EXETacNukeShockwave02_proj.bp', X * OffsetMod , 0.5, Z * OffsetMod, X, 0, Z)
    ...
    CreateHeadConvectionSpinners = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            local proj = self:CreateProjectile('/mods/BlackOpsLOUD-EXUnits/effects/Entities/EXETacNukeEffect03/EXETacNukeEffect03_proj.bp', x, HeightOffset, z, x, 0, z)
                :SetVelocity(velocity)
            table.insert(projectiles, proj)
        end
    ...
    CreateGroundPlumeConvectionEffects = function(self,army)
        ...
        for i = 0, (sides-1)
            ...
            self:CreateProjectile('/mods/BlackOpsLOUD-EXUnits/effects/Entities/EXETacNukeEffect05/EXETacNukeEffect05_proj.bp', x, RandomFloat(outer_lower_height, outer_upper_height), z, x, 0, z)
