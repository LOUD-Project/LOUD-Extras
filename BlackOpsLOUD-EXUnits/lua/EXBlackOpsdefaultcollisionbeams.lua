...
local EffectTemplate2 = import('/mods/BlackOpsLOUD-EXUnits/lua/EXEffectTemplates.lua')
local EXEffectTemplate = import('/mods/BlackOpsLOUD-EXUnits/lua/EXBlackOpsEffectTemplates.lua')

local EXCollisionBeam = import('/mods/BlackOpsLOUD-EXUnits/lua/EXCollisionBeam.lua').CollisionBeam
...
CybranSSBeam = Class(CybranBeamWeapons) {
    ...
    FxBeamStartPoint = EffectTemplate.CMicrowaveLaserMuzzle01,
    FxBeam = {'/mods/BlackOpsLOUD-EXUnits/effects/emitters/exss_beam_01_emit.bp'},
    FxBeamEndPoint = EffectTemplate.CMicrowaveLaserEndPoint01,
    FxBeamStartPointScale = 0.5,
    FxBeamEndPointScale = 0.5,
}
...
CybranAriesBeam01 = Class(CybranBeamWeapons) {
    ...
    FxBeamStartPoint = EffectTemplate.CMicrowaveLaserMuzzle01,
    FxBeam = {'/mods/BlackOpsLOUD-EXUnits/effects/emitters/exaries_beam_01_emit.bp'},
    FxBeamEndPoint = EffectTemplate.CMicrowaveLaserEndPoint01,
