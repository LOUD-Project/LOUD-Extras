...
local CybranHailfire02Projectile = import('/mods/BlackOpsLOUD-EXUnits/lua/EXBlackOpsprojectiles.lua').CybranHailfire02Projectile
   ...
   OnCreate = function(self)
    ...
    SetTurnRateByDist = function(self)
        ...
        if dist > 0 and dist <= 15 then
            ...
            local ChildProjectileBP = '/mods/BlackOpsLOUD-EXUnits/projectiles/CybranHailfire01child/CybranHailfire01child_proj.bp'
