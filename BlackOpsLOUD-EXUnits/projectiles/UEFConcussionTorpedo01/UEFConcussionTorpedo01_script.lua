...
UEFConcussionTorpedo01 = Class(TTorpedoSubProjectile) {
    ...
    MyTargetRangeCheck = function(self, TargetType, TargetEntity)
        ...
        if distance < 2 then
            nukeProjectile = self:CreateProjectile('/mods/BlackOpsLOUD-EXUnits/effects/Entities/EXCTorpEffectController01/EXCTorpEffectController01_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
