...
local SeraLambdaField = import('/mods/BlackOpsUnleashed/lua/BlackOpsdefaultantiprojectile.lua').SeraLambdaFieldDestroyer
...
EEB0001 = Class(SStructureUnit) {
    ...
    CoreEffectsCreation = function(self)
        self.Effect1 = CreateAttachedEmitter(self,0,self:GetArmy(), '/mods/BlackOpsLOUD-EXUnits/effects/emitters/exstar_01_emit.bp')
        self.Effect1:ScaleEmitter(0.15)
        WaitSeconds(2)
        self.Effect2 = CreateAttachedEmitter(self,0,self:GetArmy(), '/mods/BlackOpsLOUD-EXUnits/effects/emitters/exstar_02_emit.bp')
