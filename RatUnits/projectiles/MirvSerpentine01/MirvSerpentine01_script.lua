...
MirvSerpentine01 = Class(AQuantumWarheadProjectile) {
    ...
    PassDamageData = function(self, damageData)
        ...
        local ChildProjectileBP = '/mods/RatUnits/projectiles/AIFQuantumWarhead13/AIFQuantumWarhead13_proj.bp'
