...
CIFEMPFluxWarhead05 = Class(CEMPFluxWarheadProjectile) {
    FxSplashScale = 0.5,
    FxTrails = {},
    ...
    DoTakeDamage = function(self, instigator, amount, vector, damageType)
        ...
        CEMPFluxWarheadProjectile.DoTakeDamage(self, instigator, amount, vector, damageType)
    end,
