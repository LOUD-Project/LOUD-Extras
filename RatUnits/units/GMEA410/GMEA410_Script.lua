...
GMEA410 = Class(TAirUnit) {
    AirDestructionEffectBones = {'FrontRight_Engine_Exhaust','FrontLeft_Engine_Exhaust','BackRight_Engine_Exhaust','BackLeft_Engine_Exhaust','Engine_Exhaust01','Engine_Exhaust02','Engine_Exhaust03','Engine_Exhaust04','Engine_Exhaust05','Engine_Exhaust06','Engine_Exhaust07','Engine_Exhaust08','Engine_Exhaust09','Engine_Exhaust10',},
    ...
    Weapons = {
	MissleRackFrontLeft01 = Class(TSAMLauncher) {},
	MissleRackFrontLeft02 = Class(TSAMLauncher) {},
	MissleRackFrontLeft03 = Class(TSAMLauncher) {},
	MissleRackFrontLeft04 = Class(TSAMLauncher) {},
        MissleRackFrontLeft05 = Class(TSAMLauncher) {},
        MissleRackFrontRight01 = Class(TSAMLauncher) {},
        MissleRackFrontRight02 = Class(TSAMLauncher) {},
        MissleRackFrontRight03 = Class(TSAMLauncher) {},
        MissleRackFrontRight04 = Class(TSAMLauncher) {},
        MissleRackFrontRight05 = Class(TSAMLauncher) {},
    },
